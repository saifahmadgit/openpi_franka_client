"""RTC variant of openpi_franka.launch.py -- real-data checkpoint.

Same cameras and serials as the non-RTC real launch (no sim swap); the only
changes are the client node (openpi_rtc_node) and the RTC parameters.

DO NOT run this alongside openpi_franka.launch.py. Both drive
