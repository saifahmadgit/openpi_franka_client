                ...
                parameters=[
                    {
                        ...
                        # so feed it the physically-right camera (342522070195, the real front_2 cam).
                        # front_1 → server key cam_left_wrist.
                ...
                parameters=[
                    {
                        ...
                        # so feed it the physically-left camera (938422076779, the real front_1 cam).
                        # front_2 → server key cam_right_wrist.
                        "rgb_camera.color_profile": "640x480x30",
                        "enable_depth": False,
                        "enable_infra1": False,
                        "enable_infra2": False,
                ...
                parameters=[
                    {
                        ...
                        "debug_tag": "sim",  # → debug/sim_openpi_debug.png (distinct from real run)
                    }
                ],
            ),
        ]
